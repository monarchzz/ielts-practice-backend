...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Attachment>().HasData(SeedHelper.SeedData<Attachment>("EFCore/Seed/Attachments.json"));
        modelBuilder.Entity<User>().HasData(SeedHelper.SeedData<User>("EFCore/Seed/Users.json"));
        modelBuilder.Entity<Manager>().HasData(SeedHelper.SeedData<Manager>("EFCore/Seed/Managers.json"));
